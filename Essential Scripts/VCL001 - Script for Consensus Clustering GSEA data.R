...
thisPal_Sample<-sample(color,200) 							
thisPal_RGB<-t(col2rgb(thisPal_Sample,alpha=FALSE))
thisPal_HEX<-rgb(thisPal_RGB[,1],thisPal_RGB[,2],thisPal_RGB[,3],maxColorValue=255)
